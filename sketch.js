...
function setup() 
{
  ...
  //bubble
  bubble = createSprite(350,500,50,50);
  ...
  button.mouseClicked(drop);
   ...
   rope = new Rope(4,{x:50,y:400});
   rope2 = new Rope(4,{x:300,y:400});
  ...
  shelf = Bodies.rectangle(400,270,100,20)

  bunny = createSprite(360,height-500,100,100);
  bunny.scale = 0.2;
  ...
  fruit = Bodies.circle(150,500,20);
...
function airBlow(){
  Matter.Body.applyForce(fruit,{x:0,y:0},{x:0,y:-0.2});
  air.play();
}
